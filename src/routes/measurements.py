...
def create_measurement(
    ...
    # lógica de febre (se quiser automatizar)
...
def list_measurements_by_baby(baby_id: int, db: Session = Depends(get_db)):
    return (
        db.query(models.Measurement)
        .filter(models.Measurement.baby_id == baby_id)
